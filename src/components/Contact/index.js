  ...
  return (
    <div className="home__body">
      <div className="home__body__title">
        <h2 className="paragraphe__title">Contact</h2>
        <div className="content_card">
          ...
          >
            <label htmlFor="firstname" className="contact__form__in">
              Prénom :{" "}
              <input
            ...
            <label htmlFor="lastname" className="contact__form__in">
              Nom :{" "}
              <input
                className="contact__form__in__response"
                type="text"
            ...
            <label htmlFor="contactEmail" className="contact__form__in">
              Email :{" "}
              <input
                className="contact__form__in__response"
                type="email"
