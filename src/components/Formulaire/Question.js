 ...
 * @param {number} applicant_age - L'âge de la personne
 ...
 * @param {number} spouse_income_without_activity - autres revenus net imposables du(e la) conjoint(e)
 * @param {number} child_income1 - renvus de la personne à charge 1
    ...
    <div className="home__body">
      <form onSubmit={handleOnSubmitForm}>
        <div className="home__body__title">
          <h2 className="paragraphe__title">Le formulaire</h2>

          <ul className="form">
            <li className="form__compo">
              <fieldset>
                <legend className="form__title">Composition du foyer :</legend>
                ...
                <div className="form__compo__in">
                  ...
                  <div>
                    <label className="form__compo__in__response" htmlFor="apl">
                      Oui
                      <input
                        className="form__compo__in__response"
                        type="radio"
            ...
            <li className="form__compo">
              <fieldset>
                <legend className="form__title">Le demandeur :</legend>
                <div className="form__compo__in">
                  <span className="form__compo__in__question">
                    Quel est votre âge ?
                  </span>
                  <label htmlFor="applicant_age">
                    <div>
                      <input
                        className="form__compo__in__response"
                        type="number"
                ...
                <div className="form__compo__in">
                  <span className="form__compo__in__question">
                    Vos revenus issus du salariat de {currentYear - 2} ?
                  </span>
                  <p className="card__comment__footer">
                ...
                <div className="form__compo__in">
                  <span className="form__compo__in__question">
                    Vos revenus de {currentYear - 2} hors activité du salariat ?
                  </span>
                  <p className="card__comment__footer">
                    (Le revenu net imposable annuel)
                  </p>
            ...
            {consort && (
              <li className="form__compo">
                <fieldset>
                  <legend className="form__title">Le(a) conjoint(e)</legend>
                  <div className="form__compo__in">
                    <span className="form__compo__in__question">Son âge ?</span>
            ...
            {child && nbrInCharge >= 1 ? (
              <li className="form__compo">
                <fieldset>
                  ...
                  <div className="form__compo__in">
                    <span className="form__compo__in__question">
                      A-t-il(elle) travaillé en {currentYear - 2} ?
                    </span>
                    <div>
                      <label
                        className="form__compo__in__response"
                    ...
                    {gotJob === "true" && (
                      <div className="form__compo__in">
                        <span className="form__compo__in__question">
                          Sommes des salaires de toutes les personnes à charge
                          de {currentYear - 2} ?
                        </span>
                        <p className="card__comment__footer">
                          (Le revenu net imposable annuel)
                        </p>
                        <label htmlFor="child_income1">
                          <input
                            className="form__compo__in__response"
                            type="number"
                            name="child_income1"
      ...
      <h2 className="formResult__warning">
        - Attention ! Ceci n'est qu'une estimation, basée sur les informations
        que vous allez saisir dans le questionnaire et n'ouvre aucun droit et n'a
